...
const testimonials = [
  {
    ...
    review:
      "Raj built the frontend of an Online Attendance Management System using React for Rahul Yadav in his final year of college..",
  ...
  },
  {
    ...
    review:
      "Working with Raj was an absolute pleasure. He brings design and code together like magic. Highly recommend him!",
    image: w1,
  },
  {
    name: "Nirbhay Mishra",
    ...
    review:
      "From concept to execution, Raj handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: m2,
  },
  {
    name: "Pooja",
    ...
    review:
      "Raj transformed our outdated platform into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
