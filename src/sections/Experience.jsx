...
const experiences = [
  {
 role: "React JS Developer (Fresher)",
  company: "Self Projects & Learning",
  duration: "2024 - Present",
  description:
    "Built responsive React applications, created reusable components, and improved UI performance through optimized code practices"
  },
