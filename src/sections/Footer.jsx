...
const socials = [
  ...
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/rajgupta1729?igsh=Z3VldHZudmdlc3Q4" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Raj8487/Javascript_Notes" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Raj Gupta. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
